...
public:
     ...
     *
     * @param target Object to compute function value in point.
     * @param regularizer Object to compute regularizer value in point.
     * @param prox Object to compute prox-function value in point.
     * @param adTarget Object to compute function subgradient in point.
     * @param adRegularizer Object to compute regularizer subgradient in point.
     * @param adProx Object to compute prox-function value in point.
...
private:
    /// @brief Object to compute target function value in point.
    std::shared_ptr<const DoubleFunction> target;
    /// @brief Object to compute regularizer value in point.
    std::shared_ptr<const DoubleFunction> regularizer;
    /// @brief Object to compute prox-function value in point.
    std::shared_ptr<const DoubleFunction> prox;

    /// @brief Object to compute target function sugradeint in point.
    std::shared_ptr<const CppADFunction> adTarget;
    /// @brief Object to compute regularizer subgradient in point.
    std::shared_ptr<const CppADFunction> adRegularizer;
    /// @brief Object to compute prox-function subgradient in point.
