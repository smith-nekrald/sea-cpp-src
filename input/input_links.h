...
struct InputLinks {
    ...
    /// @brief Maps allotment id to index of select-one groups having this allotment. Recall that at 
    /// most one allotment from each select-one group is accepted. The indexation is as follows:
